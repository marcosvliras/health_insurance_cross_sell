...
class HealthInsurance(object):
    ...
    def data_selection(self, df1: pd.DataFrame) -> pd.DataFrame:
        """Rename columns."""
        old_columns = [
            "id",
            "Gender",
    ...
    def data_preparation(self, df5: pd.DataFrame) -> pd.DataFrame:
    ...
    def get_predictions(
        self, model, original_data: pd.DataFrame, test_data: pd.DataFrame
    ) -> any:
        """Score the data."""
